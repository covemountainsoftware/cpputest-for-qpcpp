...
TEST(OrthogonalComponentTests, upon_starting_a_component_it_can_subscribe_and_perform_initial_hsm_transition) {
    createUnitUnderTest();
    startUnitUnderTest();
}
...
TEST(OrthogonalComponentTests, component_will_not_process_undesired_published_signal) {
...
TEST(OrthogonalComponentTests, component_will_process_desired_direct_post_signal) {
