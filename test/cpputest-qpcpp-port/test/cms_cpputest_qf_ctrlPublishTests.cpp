...
TEST(qf_ctrlPublishTests, qf_ctrl_provides_a_trivial_publish_from_test_helper_func) {
    ...
    CHECK_TRUE(mRecorder->isSignalRecorded(TEST1_PUBLISH_SIG)); //expect first event
    CHECK_TRUE(mRecorder->isSignalRecorded(TEST2_PUBLISH_SIG)); //expect second event
}

TEST(qf_ctrlPublishTests, qf_ctrl_provides_a_trivial_publish_and_process_from_test_helper_func) {
    qf_ctrl::PublishAndProcess(TEST1_PUBLISH_SIG);
    CHECK_TRUE(mRecorder->isSignalRecorded(TEST1_PUBLISH_SIG));
}

TEST(qf_ctrlPublishTests, qf_ctrl_provides_a_trivial_publish_and_process_from_test_helper_func_with_recorder_ignore_option) {
...
TEST(qf_ctrlPublishTests, qf_ctrl_provides_a_qevt_publish_and_process_from_test_helper_func) {
    auto e = Q_NEW(QP::QEvt, TEST1_PUBLISH_SIG);
...
TEST(qf_ctrlPublishTests, qf_ctrl_provides_a_qevt_publish_and_process_from_test_helper_func_with_recorder_ignore_option) {
    auto e = Q_NEW(QP::QEvt, TEST1_PUBLISH_SIG);
